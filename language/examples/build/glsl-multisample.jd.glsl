...
/* (
    ...
    return Mat4#🗣️{TODO SPREADs}{
        r1: vec4#🎆🌷🧑‍🦰😃(ca#:7 * cb#:5, ca#:7 * sb#:6 * sg#:4 - sa#:8 * cg#:3, ca#:7 * sb#:6 * cg#:3 + sa#:8 * sg#:4, 0),
        r2: vec4#🎆🌷🧑‍🦰😃(sa#:8 * cb#:5, sa#:8 * sb#:6 * sg#:4 + ca#:7 * cg#:3, sa#:8 * sb#:6 * cg#:3 - ca#:7 * sg#:4, 0),
...
mat4 rotate_d804569c(float tx_0, float ty_1, float tz_2) {
    ...
    float sa = sin(tz_2);
    return mat4(
        vec4_4d4983bb((ca * cb), (((ca * sb) * sg) - (sa * cg)), (((ca * sb) * cg) + (sa * sg)), 0.0),
        vec4_4d4983bb((sa * cb), (((sa * sb) * sg) + (ca * cg)), (((sa * sb) * cg) - (ca * sg)), 0.0),
...
/* (
    ...
    y#:2: float,
    z#:3: float,
): Vec3#🐬 => xyz#🐭🕔🤸(generated#16557d10_1de4e4c0_0(rotate#🥪(x#:1, y#:2, z#:3), vec4#🏊‍♂️(v#:0, 1))) */
vec3 rotate_6734d670(vec3 v_0, float x_1, float y_2, float z_3) {
    return xyz_1aedf216(V16557d10_1de4e4c0_0(rotate_d804569c(x_1, y_2, z_3), vec4_b00b79a0(v_0, 1.0)));
}
/* -- generated -- */
...
/* (env#:0: GLSLEnv#🕷️⚓😣😃, pos#:1: Vec3#🐬): float => {
    const pos#:2: Vec3#🐬 = rotate#🍊💂‍♂️🍍😃(pos#:1, 0, env#:0.#GLSLEnv#🕷️⚓😣😃#0 / 2, env#:0.#GLSLEnv#🕷️⚓😣😃#0);
    const period#:4: float = 30 * sin(env#:0.#GLSLEnv#🕷️⚓😣😃#0) + 1;
    return length#🕓🤬🐲😃(pos#:2) - 0.5 - (sin(pos#:2.#Vec2#🐭😉😵😃#0 * period#:4) + sin(pos#:2.#Vec3#🐬#0 * period#:4) + sin(pos#:2.#Vec2#🐭😉😵😃#1 * period#:4)) / ((sin(
        env#:0.#GLSLEnv#🕷️⚓😣😃#0 / 2,
    ) + 1) * (60) + 1);
} */
float ok_lambda_aaa6336a(GLSLEnv_451d5252 env_0, vec3 pos_1) {
    ...
    return ((length_63e16b7a(pos) - 0.50) - (((sin((pos.x * period)) + sin((pos.z * period))) + sin((pos.y * period))) / (((sin((env_0.time / 2.0)) + 1.0) * 60.0) + 1.0)));
}
/**
```
...
/* (
    ...
    y#:1: float,
    z#:2: float,
): Vec3#🐬 => Vec3#🐬{TODO SPREADs}{z: z#:2, x: x#:0, y: y#:1} */
vec3 vec3_18cdf03e(float x_0, float y_1, float z_2) {
...
/* -- generated -- */
/* (v#:0: Vec4#🕒🧑‍🏫🎃, scale#:1: float): Vec4#🕒🧑‍🏫🎃 => Vec4#🕒🧑‍🏫🎃{TODO SPREADs}{w: v#:0.#Vec4#🕒🧑‍🏫🎃#0 / scale#:1, z: v#:0.#Vec3#🐬#0 / scale#:1} */
vec4 V56d43c0e_5ac12902_0(
    vec4 v_0,
    float scale_1
) {
...
```
*/
/* (x#:0: float, y#:1: float): Vec2#🐭😉😵😃 => Vec2#🐭😉😵😃{TODO SPREADs}{
    x: x#:0,
    y: y#:1,
} */
vec2 vec2_54a9f2ef(float x_0, float y_1) {
    return vec2(x_0, y_1);
}
/* -- generated -- */
...
/* (env#:1: GLSLEnv#🕷️⚓😣😃, p#:2: Vec3#🐬): Vec3#🐬 => normalize#🦡🤹🕳️😃(
    vec3#🧐🕔🧖(
        ok_lambda#🧳(env#:1, Vec3#🐬{TODO SPREADs}{z: p#:2.#Vec3#🐬#0, x: p#:2.#Vec2#🐭😉😵😃#0 + EPSILON#🧂💃🚶‍♂️, y: p#:2.#Vec2#🐭😉😵😃#1}) - ok_lambda#🧳(
            env#:1,
            Vec3#🐬{TODO SPREADs}{z: p#:2.#Vec3#🐬#0, x: p#:2.#Vec2#🐭😉😵😃#0 - EPSILON#🧂💃🚶‍♂️, y: p#:2.#Vec2#🐭😉😵😃#1},
        ),
        ok_lambda#🧳(env#:1, Vec3#🐬{TODO SPREADs}{z: p#:2.#Vec3#🐬#0, x: p#:2.#Vec2#🐭😉😵😃#0, y: p#:2.#Vec2#🐭😉😵😃#1 + EPSILON#🧂💃🚶‍♂️}) - ok_lambda#🧳(
            env#:1,
            Vec3#🐬{TODO SPREADs}{z: p#:2.#Vec3#🐬#0, x: p#:2.#Vec2#🐭😉😵😃#0, y: p#:2.#Vec2#🐭😉😵😃#1 - EPSILON#🧂💃🚶‍♂️},
        ),
        ok_lambda#🧳(env#:1, Vec3#🐬{TODO SPREADs}{z: p#:2.#Vec3#🐬#0 + EPSILON#🧂💃🚶‍♂️, x: p#:2.#Vec2#🐭😉😵😃#0, y: p#:2.#Vec2#🐭😉😵😃#1}) - ok_lambda#🧳(
            env#:1,
            Vec3#🐬{TODO SPREADs}{z: p#:2.#Vec3#🐬#0 - EPSILON#🧂💃🚶‍♂️, x: p#:2.#Vec2#🐭😉😵😃#0, y: p#:2.#Vec2#🐭😉😵😃#1},
        ),
    ),
) */
vec3 estimateNormal_specialization_7579ca6e(GLSLEnv_451d5252 env_1, vec3 p_2) {
    return normalize_48e6ea27(
        vec3_18cdf03e(
            (ok_lambda_aaa6336a(env_1, vec3((p_2.x + EPSILON_17261aaa), p_2.y, p_2.z)) - ok_lambda_aaa6336a(env_1, vec3((p_2.x - EPSILON_17261aaa), p_2.y, p_2.z))),
            (ok_lambda_aaa6336a(env_1, vec3(p_2.x, (p_2.y + EPSILON_17261aaa), p_2.z)) - ok_lambda_aaa6336a(env_1, vec3(p_2.x, (p_2.y - EPSILON_17261aaa), p_2.z))),
            (ok_lambda_aaa6336a(env_1, vec3(p_2.x, p_2.y, (p_2.z + EPSILON_17261aaa))) - ok_lambda_aaa6336a(env_1, vec3(p_2.x, p_2.y, (p_2.z - EPSILON_17261aaa))))
        )
    );
}
/**
...
/* (env#:1: GLSLEnv#🕷️⚓😣😃, eye#:2: Vec3#🐬, marchingDirection#:3: Vec3#🐬, start#:4: float, end#:5: float, stepsLeft#:6: int): float => {
    loop {
        const dist#:7: float = ok_lambda#🧳(env#:1, generated#1c6fdd91_b99b22d8_0(eye#:2, generated#c4a91006_1de4e4c0_0(start#:4, marchingDirection#:3)));
        if dist#:7 < EPSILON#🧂💃🚶‍♂️ {
            return start#:4;
        } else {
...
float shortestDistanceToSurface_specialization_0bcae438(GLSLEnv_451d5252 env_1, vec3 eye_2, vec3 marchingDirection_3, float start_4, float end_5, int stepsLeft_6) {
    for (int i=0; i<10000; i++) {
        float dist = ok_lambda_aaa6336a(env_1, V1c6fdd91_b99b22d8_0(eye_2, Vc4a91006_1de4e4c0_0(start_4, marchingDirection_3)));
...
/* (
    ...
    const worldDir#:19: Vec3#🐬 = getWorldDir#🎁(arg0#:41.#GLSLEnv#🕷️⚓😣😃#1, arg1#:42, eye#:18, 45);
    const dist#:20: float = shortestDistanceToSurface_specialization#😵🍡👂(arg0#:41, eye#:18, worldDir#:19, 0, 100, 255);
    if dist#:20 > 100 - EPSILON#🧂💃🚶‍♂️ {
        result#:43 = vec4#🤽🚇🚞😃(0);
    } else {
        result#:43 = vec4#🏊‍♂️(estimateNormal_specialization#🍈🍌🚤😃(arg0#:41, generated#1c6fdd91_b99b22d8_0(eye#:18, generated#1d31aa6e_1de4e4c0_0(worldDir#:19, dist#:20))), 1);
    };
    const result#:45: Vec4#🕒🧑‍🏫🎃;
    const eye#:23: Vec3#🐬 = Vec3#🐬{TODO SPREADs}{z: 5, x: 0, y: 0};
    const worldDir#:24: Vec3#🐬 = getWorldDir#🎁(arg0#:41.#GLSLEnv#🕷️⚓😣😃#1, generated#70bb2056_b99b22d8_0(arg1#:42, vec2#⛰️🍅👨‍🍼😃(0.5, 0)), eye#:23, 45);
    const dist#:25: float = shortestDistanceToSurface_specialization#😵🍡👂(arg0#:41, eye#:23, worldDir#:24, 0, 100, 255);
    if dist#:25 > 100 - EPSILON#🧂💃🚶‍♂️ {
        result#:45 = vec4#🤽🚇🚞😃(0);
    } else {
        result#:45 = vec4#🏊‍♂️(estimateNormal_specialization#🍈🍌🚤😃(arg0#:41, generated#1c6fdd91_b99b22d8_0(eye#:23, generated#1d31aa6e_1de4e4c0_0(worldDir#:24, dist#:25))), 1);
    };
    const result#:47: Vec4#🕒🧑‍🏫🎃;
    const eye#:28: Vec3#🐬 = Vec3#🐬{TODO SPREADs}{z: 5, x: 0, y: 0};
    const worldDir#:29: Vec3#🐬 = getWorldDir#🎁(arg0#:41.#GLSLEnv#🕷️⚓😣😃#1, generated#70bb2056_b99b22d8_0(arg1#:42, vec2#⛰️🍅👨‍🍼😃(-0.5, 0)), eye#:28, 45);
    const dist#:30: float = shortestDistanceToSurface_specialization#😵🍡👂(arg0#:41, eye#:28, worldDir#:29, 0, 100, 255);
    if dist#:30 > 100 - EPSILON#🧂💃🚶‍♂️ {
        result#:47 = vec4#🤽🚇🚞😃(0);
    } else {
        result#:47 = vec4#🏊‍♂️(estimateNormal_specialization#🍈🍌🚤😃(arg0#:41, generated#1c6fdd91_b99b22d8_0(eye#:28, generated#1d31aa6e_1de4e4c0_0(worldDir#:29, dist#:30))), 1);
    };
    const result#:49: Vec4#🕒🧑‍🏫🎃;
    const eye#:33: Vec3#🐬 = Vec3#🐬{TODO SPREADs}{z: 5, x: 0, y: 0};
    const worldDir#:34: Vec3#🐬 = getWorldDir#🎁(arg0#:41.#GLSLEnv#🕷️⚓😣😃#1, generated#70bb2056_b99b22d8_0(arg1#:42, vec2#⛰️🍅👨‍🍼😃(0, 0.5)), eye#:33, 45);
    const dist#:35: float = shortestDistanceToSurface_specialization#😵🍡👂(arg0#:41, eye#:33, worldDir#:34, 0, 100, 255);
    if dist#:35 > 100 - EPSILON#🧂💃🚶‍♂️ {
        result#:49 = vec4#🤽🚇🚞😃(0);
    } else {
        result#:49 = vec4#🏊‍♂️(estimateNormal_specialization#🍈🍌🚤😃(arg0#:41, generated#1c6fdd91_b99b22d8_0(eye#:33, generated#1d31aa6e_1de4e4c0_0(worldDir#:34, dist#:35))), 1);
    };
    const result#:51: Vec4#🕒🧑‍🏫🎃;
    const eye#:38: Vec3#🐬 = Vec3#🐬{TODO SPREADs}{z: 5, x: 0, y: 0};
    const worldDir#:39: Vec3#🐬 = getWorldDir#🎁(arg0#:41.#GLSLEnv#🕷️⚓😣😃#1, generated#70bb2056_b99b22d8_0(arg1#:42, vec2#⛰️🍅👨‍🍼😃(0, -0.5)), eye#:38, 45);
    const dist#:40: float = shortestDistanceToSurface_specialization#😵🍡👂(arg0#:41, eye#:38, worldDir#:39, 0, 100, 255);
    if dist#:40 > 100 - EPSILON#🧂💃🚶‍♂️ {
        result#:51 = vec4#🤽🚇🚞😃(0);
    } else {
        result#:51 = vec4#🏊‍♂️(estimateNormal_specialization#🍈🍌🚤😃(arg0#:41, generated#1c6fdd91_b99b22d8_0(eye#:38, generated#1d31aa6e_1de4e4c0_0(worldDir#:39, dist#:40))), 1);
    };
    return generated#56d43c0e_5ac12902_0(
        generated#0555d260_b99b22d8_0(generated#0555d260_b99b22d8_0(generated#0555d260_b99b22d8_0(generated#0555d260_b99b22d8_0(result#:43, result#:45), result#:47), result#:49), result#:51),
        5,
    );
} */
vec4 ok_0cccfe1a(GLSLEnv_451d5252 arg0_41, vec2 arg1_42) {
    ...
    float dist_20 = shortestDistanceToSurface_specialization_0bcae438(arg0_41, eye, worldDir, 0.0, 100.0, 255);
    if ((dist_20 > (100.0 - EPSILON_17261aaa))) {
        result = vec4_72fca9b4(0.0);
    } else {
        result = vec4_b00b79a0(estimateNormal_specialization_7579ca6e(arg0_41, V1c6fdd91_b99b22d8_0(eye, V1d31aa6e_1de4e4c0_0(worldDir, dist_20))), 1.0);
    };
    vec4 result_45;
    vec3 eye_23 = vec3(0.0, 0.0, 5.0);
    vec3 worldDir_24 = getWorldDir_92052fca(arg0_41.resolution, V70bb2056_b99b22d8_0(arg1_42, vec2_54a9f2ef(0.50, 0.0)), eye_23, 45.0);
    float dist_25 = shortestDistanceToSurface_specialization_0bcae438(arg0_41, eye_23, worldDir_24, 0.0, 100.0, 255);
    if ((dist_25 > (100.0 - EPSILON_17261aaa))) {
        result_45 = vec4_72fca9b4(0.0);
    } else {
        result_45 = vec4_b00b79a0(estimateNormal_specialization_7579ca6e(arg0_41, V1c6fdd91_b99b22d8_0(eye_23, V1d31aa6e_1de4e4c0_0(worldDir_24, dist_25))), 1.0);
    };
    vec4 result_47;
    vec3 eye_28 = vec3(0.0, 0.0, 5.0);
    vec3 worldDir_29 = getWorldDir_92052fca(arg0_41.resolution, V70bb2056_b99b22d8_0(arg1_42, vec2_54a9f2ef(-0.50, 0.0)), eye_28, 45.0);
    float dist_30 = shortestDistanceToSurface_specialization_0bcae438(arg0_41, eye_28, worldDir_29, 0.0, 100.0, 255);
    if ((dist_30 > (100.0 - EPSILON_17261aaa))) {
        result_47 = vec4_72fca9b4(0.0);
    } else {
        result_47 = vec4_b00b79a0(estimateNormal_specialization_7579ca6e(arg0_41, V1c6fdd91_b99b22d8_0(eye_28, V1d31aa6e_1de4e4c0_0(worldDir_29, dist_30))), 1.0);
    };
    vec4 result_49;
    vec3 eye_33 = vec3(0.0, 0.0, 5.0);
    vec3 worldDir_34 = getWorldDir_92052fca(arg0_41.resolution, V70bb2056_b99b22d8_0(arg1_42, vec2_54a9f2ef(0.0, 0.50)), eye_33, 45.0);
    float dist_35 = shortestDistanceToSurface_specialization_0bcae438(arg0_41, eye_33, worldDir_34, 0.0, 100.0, 255);
    if ((dist_35 > (100.0 - EPSILON_17261aaa))) {
        result_49 = vec4_72fca9b4(0.0);
    } else {
        result_49 = vec4_b00b79a0(estimateNormal_specialization_7579ca6e(arg0_41, V1c6fdd91_b99b22d8_0(eye_33, V1d31aa6e_1de4e4c0_0(worldDir_34, dist_35))), 1.0);
    };
    vec4 result_51;
    vec3 eye_38 = vec3(0.0, 0.0, 5.0);
    vec3 worldDir_39 = getWorldDir_92052fca(arg0_41.resolution, V70bb2056_b99b22d8_0(arg1_42, vec2_54a9f2ef(0.0, -0.50)), eye_38, 45.0);
    float dist_40 = shortestDistanceToSurface_specialization_0bcae438(arg0_41, eye_38, worldDir_39, 0.0, 100.0, 255);
    if ((dist_40 > (100.0 - EPSILON_17261aaa))) {
        result_51 = vec4_72fca9b4(0.0);
    } else {
        result_51 = vec4_b00b79a0(estimateNormal_specialization_7579ca6e(arg0_41, V1c6fdd91_b99b22d8_0(eye_38, V1d31aa6e_1de4e4c0_0(worldDir_39, dist_40))), 1.0);
    };
    return V56d43c0e_5ac12902_0(V0555d260_b99b22d8_0(V0555d260_b99b22d8_0(V0555d260_b99b22d8_0(V0555d260_b99b22d8_0(result, result_45), result_47), result_49), result_51), 5.0);
}
void main() {
    fragColor = ok_0cccfe1a(GLSLEnv_451d5252(u_time, u_resolution, u_camera, u_mouse), gl_FragCoord.xy);
}