...
/**
```
const distance#29bb6cab: (Vec3#9f1c0644, Vec3#9f1c0644) ={}> float = (
    one#:0: Vec3#9f1c0644,
    two#:1: Vec3#9f1c0644,
) ={}> length#63e16b7a((two#:1 -#1c6fdd91#b99b22d8#1 one#:0))
```
*/
...
/**
```
const dot#a0178052: (Vec4#3b941378, Vec4#3b941378) ={}> float = (
    a#:0: Vec4#3b941378,
    b#:1: Vec4#3b941378,
) ={}> {
