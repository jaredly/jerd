...
```
*/
export const hash_39fb69e2: (arg_0: t_43802a16, arg_1: t_23c98f91) => number = (p: t_43802a16, circle: t_23c98f91) => hash_2e6a5f32(hash_70bb2056.hb99b22d8_1(p, circle.h23c98f91_0)) - circle.h23c98f91_1;
...
```
*/
export const hash_a42728cc: t_0c2608f2<number> = ({
  type: "0c2608f2",
  h0c2608f2_0: min
} as t_0c2608f2<number>);
...
```
*/
export const hash_7fbfbfda: (arg_0: t_451d5252, arg_1: t_43802a16) => t_3b941378 = (env: t_451d5252, fragCoord: t_43802a16) => {
  let lambdaBlockResult: t_9f1c0644 = (null as any);
  let continueBlock: boolean = true;

  if (hash_a42728cc.h0c2608f2_0(hash_39fb69e2(fragCoord, ({
    type: "23c98f91",
    h23c98f91_0: env.mouse,
    h23c98f91_1: 40 + cos(env.time * 4) * 20
  } as t_23c98f91)), hash_39fb69e2(fragCoord, ({
    type: "23c98f91",
    h23c98f91_0: hash_70bb2056.hb99b22d8_0(env.mouse, ({
      type: "Vec2",
      x: 10,
      y: 20
    } as t_43802a16)),
...
export const hello = hash_7fbfbfda;