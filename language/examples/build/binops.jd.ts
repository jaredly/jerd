...
/**
```
const IntArrayAddable#d813fe5c = Addable#0c2608f2<Array#builtin<int#builtin>>{
    "+"#0c2608f2#0: (a#:0: Array#builtin<int#builtin>, b#:1: Array#builtin<int#builtin>): Array#builtin<
        int#builtin,
    > ={}> concat#builtin<int#builtin>(a#:0, b#:1),
}
```
*/
export const hash_d813fe5c: t_0c2608f2<Array<number>> = ({
  type: "0c2608f2",
  h0c2608f2_0: (a: Array<number>, b: Array<number>) => concat(a, b)
} as t_0c2608f2<Array<number>>);

/*
<int#builtin>[1] +#d813fe5c#0c2608f2#0 <int#builtin>[2, 3]
*/
hash_d813fe5c.h0c2608f2_0([1], [2, 3]);
