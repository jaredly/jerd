...
/**
```
const ArrayIntEq#5a856a34 = ArrayEq#5c78f7e8<int#builtin>(eq: IntEq#9275f914)
```
*/
export const hash_5a856a34: t_553b4b8e<Array<number>> = hash_5c78f7e8(hash_9275f914);
...
/**
```
const IntArrayAddable#e591f086 = Addable#5cfbbc08<Array#builtin<int#builtin>>{
    "+"#5cfbbc08#0: (a#:0: Array#builtin<int#builtin>, b#:1: Array#builtin<int#builtin>): Array#builtin<
        int#builtin,
    > ={}> concat#builtin<int#builtin>(a#:0, b#:1),
}
```
*/
export const hash_e591f086: t_5cfbbc08<Array<number>> = ({
  type: "5cfbbc08",
  h5cfbbc08_0: (a: Array<number>, b: Array<number>) => concat(a, b)
} as t_5cfbbc08<Array<number>>);

/*
<int#builtin>[1] +#e591f086#5cfbbc08#0 <int#builtin>[2, 3]
*/
hash_e591f086.h5cfbbc08_0([1], [2, 3]);
...
/*
ArrayEq#5c78f7e8<int#builtin>(eq: IntEq#9275f914)."=="#553b4b8e#0(
    <int#builtin>[1, 2],
    <int#builtin>[1, 2],
)
*/
assertCall(hash_5c78f7e8(hash_9275f914).h553b4b8e_0, [1, 2], [1, 2]);
...
*/
assertCall(hash_5c78f7e8(hash_9275f914).h553b4b8e_0, [1, 2, 3], [1, 2, 3]);

/*
<int#builtin>[1, 2] ==#5a856a34#553b4b8e#0 <int#builtin>[1, 2]
*/
assertCall(hash_5a856a34.h553b4b8e_0, [1, 2], [1, 2]);
