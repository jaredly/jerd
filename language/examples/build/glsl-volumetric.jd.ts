...
/**
```
const rec shortestDistanceToSurface#eaf0d810 = (
    ...
    if stepsLeft#:6 <=#builtin 0 {
        ...
        const dist#:7 = sceneSDF#:0(
            iTime#:1,
            eye#:2 +#8e58b954#b99b22d8#0 start#:4 *#44baf212#1de4e4c0#0 marchingDirection#:3,
        );
...
```
*/
export const hash_eaf0d810: (arg_0: (arg_0: number, arg_1: t_9f1c0644) => number, arg_1: number, arg_2: t_9f1c0644, arg_3: t_9f1c0644, arg_4: number, arg_5: number, arg_6: number) => number = (sceneSDF: (arg_0: number, arg_1: t_9f1c0644) => number, iTime: number, eye: t_9f1c0644, marchingDirection: t_9f1c0644, start: number, end: number, stepsLeft: number) => {
  while (true) {
    let dist: number = sceneSDF(iTime, hash_8e58b954.hb99b22d8_0(eye, hash_44baf212.h1de4e4c0_0(start, marchingDirection)));
...
/**
```
const estimateNormal#15db469c = (
    sceneSDF#:0: (float#builtin, Vec3#9f1c0644) ={}> float#builtin,
    iTime#:1: float#builtin,
    p#:2: Vec3#9f1c0644,
): Vec3#9f1c0644 ={}> normalize#d508ff52(
    v: Vec3#9f1c0644{
...
```
*/
export const hash_15db469c: (arg_0: (arg_0: number, arg_1: t_9f1c0644) => number, arg_1: number, arg_2: t_9f1c0644) => t_9f1c0644 = (sceneSDF: (arg_0: number, arg_1: t_9f1c0644) => number, iTime: number, p: t_9f1c0644) => hash_d508ff52(({
  type: "Vec3",
  x: sceneSDF(iTime, ({ ...p,
    type: "Vec3",
    x: p.x + hash_ec7f8d1c
...
/**
```
const volumetricSample#1194dc07 = (
    sceneSDF#:0: (float#builtin, Vec3#9f1c0644) ={}> float#builtin,
    iTime#:1: float#builtin,
    ...
    const sample#:9 = eye#:3 +#8e58b954#b99b22d8#0 rdist#:8 *#44baf212#1de4e4c0#0 dir#:6;
    const lightDist#:10 = distance#5b517fea(one: sample#:9, two: light#:2);
    const toLight#:11 = sample#:9 -#8e58b954#b99b22d8#1 light#:2;
    const marchToLight#:12 = shortestDistanceToSurface#eaf0d810(
        sceneSDF#:0,
        iTime#:1,
        eye: sample#:9,
        marchingDirection: -1.0 *#44baf212#1de4e4c0#0 normalize#d508ff52(v: toLight#:11),
        start: 0.0,
        end: lightDist#:10,
...
```
*/
export const hash_1194dc07: (arg_0: (arg_0: number, arg_1: t_9f1c0644) => number, arg_1: number, arg_2: t_9f1c0644, arg_3: t_9f1c0644, arg_4: number, arg_5: number, arg_6: t_9f1c0644, arg_7: number) => number = (sceneSDF: (arg_0: number, arg_1: t_9f1c0644) => number, iTime: number, light: t_9f1c0644, eye$3: t_9f1c0644, dist$4: number, percent: number, dir: t_9f1c0644, left: number) => {
  let sample: t_9f1c0644 = hash_8e58b954.hb99b22d8_0(eye$3, hash_44baf212.h1de4e4c0_0(percent * dist$4, dir));
  let lightDist: number = hash_5b517fea(sample, light);

  if (hash_eaf0d810(sceneSDF, iTime, sample, hash_44baf212.h1de4e4c0_0(-1, hash_d508ff52(hash_8e58b954.hb99b22d8_1(sample, light))), 0, lightDist, hash_62404440) >= lightDist - 0.1) {
...
/**
```
const isPointingTowardLight#4f133e4c = (
    sceneSDF#:0: (float#builtin, Vec3#9f1c0644) ={}> float#builtin,
    iTime#:1: float#builtin,
    p#:2: Vec3#9f1c0644,
    lightPos#:3: Vec3#9f1c0644,
): bool#builtin ={}> {
    const N#:4 = estimateNormal#15db469c(sceneSDF#:0, iTime#:1, p#:2);
    const L#:5 = normalize#d508ff52(v: lightPos#:3 -#8e58b954#b99b22d8#1 p#:2);
    const dotLN#:6 = dot#e17ea18c(a: L#:5, b: N#:4);
    dotLN#:6 >=#builtin 0.0;
}
```
*/
export const hash_4f133e4c: (arg_0: (arg_0: number, arg_1: t_9f1c0644) => number, arg_1: number, arg_2: t_9f1c0644, arg_3: t_9f1c0644) => boolean = (sceneSDF: (arg_0: number, arg_1: t_9f1c0644) => number, iTime: number, p: t_9f1c0644, lightPos: t_9f1c0644) => hash_e17ea18c(hash_d508ff52(hash_8e58b954.hb99b22d8_1(lightPos, p)), hash_15db469c(sceneSDF, iTime, p)) >= 0;
...
/**
```
const cross#69ae30ca = (one#:0: Vec3#9f1c0644, two#:1: Vec3#9f1c0644): Vec3#9f1c0644 ={}> Vec3#9f1c0644{
...
```
*/
export const hash_69ae30ca: (arg_0: t_9f1c0644, arg_1: t_9f1c0644) => t_9f1c0644 = (one: t_9f1c0644, two: t_9f1c0644) => ({
  type: "Vec3",
...
```
*/
export const hash_4e4607e8: (arg_0: t_9f1c0644, arg_1: number, arg_2: t_9f1c0644) => t_9f1c0644 = (p$0: t_9f1c0644, c: number, l: t_9f1c0644) => hash_8e58b954.hb99b22d8_1(p$0, hash_44baf212.h1de4e4c0_0(c, hash_6954efc0(hash_5089ef00(hash_8863b0ac.h5ac12902_0(p$0, c)), hash_52db783c.h3c2a4898_0(l), l)));
...
/**
```
const AddSubVec2_#57b370c6 = AddSub#b99b22d8<Vec2#43802a16, float#builtin, Vec2#43802a16>{
...
```
*/
export const hash_57b370c6: t_b99b22d8<t_43802a16, number, t_43802a16> = ({
  type: "b99b22d8",
...
const rec volumetric#76cd4800 = (
    ...
    if left#:8 <=#builtin 0 {
        ...
        const sample#:11 = volumetricSample#1194dc07(
            sceneSDF#:0,
            iTime#:1,
            light#:3,
            eye#:4,
...
```
*/
export const hash_76cd4800: (arg_0: (arg_0: number, arg_1: t_9f1c0644) => number, arg_1: number, arg_2: t_43802a16, arg_3: t_9f1c0644, arg_4: t_9f1c0644, arg_5: number, arg_6: t_9f1c0644, arg_7: number, arg_8: number, arg_9: number) => number = (sceneSDF: (arg_0: number, arg_1: t_9f1c0644) => number, iTime: number, seed: t_43802a16, light$3: t_9f1c0644, eye$4: t_9f1c0644, dist$5: number, dir: t_9f1c0644, current: number, left$8: number, total: number) => {
  while (true) {
    current = current + hash_1194dc07(sceneSDF, iTime, light$3, eye$4, dist$5, hash_6f186ad1.hAs_0(left$8) / total, dir, left$8);
    continue;
  }
...
const lightSurface#f1a321da = (
    ...
    if isPointingTowardLight#4f133e4c(
        sceneSDF#:0,
        iTime#:1,
        p: worldPosForPixel#:2,
        lightPos: light1Pos#:3,
    ) {
        const toLight#:6 = light1Pos#:3 -#8e58b954#b99b22d8#1 worldPosForPixel#:2;
        const marchToLight#:7 = shortestDistanceToSurface#eaf0d810(
            sceneSDF#:0,
            iTime#:1,
            eye: light1Pos#:3,
            marchingDirection: -1.0 *#44baf212#1de4e4c0#0 normalize#d508ff52(v: toLight#:6),
        ...
        if marchToLight#:7 >#builtin MAX_DIST#0ce717e6 -#builtin EPSILON#ec7f8d1c *#builtin 10.0 {
            Vec4#3b941378{...white#0678f03c *#42016d26#1de4e4c0#0 light#:4, w#3b941378#0: 1.0};
        } else {
            const offset#:8 = marchToLight#:7 -#builtin length#1e74e8e4(v: toLight#:6);
            const penumbra#:9 = 0.1;
            if offset#:8 <#builtin -EPSILON#ec7f8d1c *#builtin 1000.0 {
                Vec4#3b941378{...white#0678f03c *#42016d26#1de4e4c0#0 light#:4, w#3b941378#0: 1.0};
            } else {
                Vec4#3b941378{...white#0678f03c *#42016d26#1de4e4c0#0 hit#:5, w#3b941378#0: 1.0};
            };
        };
    } else {
        Vec4#3b941378{...white#0678f03c *#42016d26#1de4e4c0#0 light#:4, w#3b941378#0: 1.0};
...
```
*/
export const hash_f1a321da: (arg_0: (arg_0: number, arg_1: t_9f1c0644) => number, arg_1: number, arg_2: t_9f1c0644, arg_3: t_9f1c0644, arg_4: number, arg_5: number) => t_3b941378 = (sceneSDF: (arg_0: number, arg_1: t_9f1c0644) => number, iTime: number, worldPosForPixel: t_9f1c0644, light1Pos: t_9f1c0644, light$4: number, hit: number) => {
  if (hash_4f133e4c(sceneSDF, iTime, worldPosForPixel, light1Pos)) {
    let toLight: t_9f1c0644 = hash_8e58b954.hb99b22d8_1(light1Pos, worldPosForPixel);
    let marchToLight: number = hash_eaf0d810(sceneSDF, iTime, light1Pos, hash_44baf212.h1de4e4c0_0(-1, hash_d508ff52(toLight)), hash_f2cd39b8, hash_0ce717e6, hash_62404440);

    if (marchToLight > hash_0ce717e6 - hash_ec7f8d1c * 10) {
      return ({ ...hash_42016d26.h1de4e4c0_0(hash_0678f03c, light$4),
        type: "Vec4",
        w: 1
      } as t_3b941378);
    } else {
      if (marchToLight - hash_1e74e8e4(toLight) < -hash_ec7f8d1c * 1000) {
        ...
        return ({ ...hash_42016d26.h1de4e4c0_0(hash_0678f03c, hit),
          type: "Vec4",
          w: 1
        } as t_3b941378);
      }
...
/**
```
const viewMatrix#123fd152 = (eye#:0: Vec3#9f1c0644, center#:1: Vec3#9f1c0644, up#:2: Vec3#9f1c0644): Mat4#d92781e8 ={}> {
    const f#:3 = normalize#d508ff52(v: center#:1 -#8e58b954#b99b22d8#1 eye#:0);
    const s#:4 = normalize#d508ff52(v: cross#69ae30ca(one: f#:3, two: up#:2));
    const u#:5 = cross#69ae30ca(one: s#:4, two: f#:3);
    Mat4#d92781e8{
        r1#d92781e8#0: Vec4#3b941378{...s#:4, w#3b941378#0: 0.0},
        r2#d92781e8#1: Vec4#3b941378{...u#:5, w#3b941378#0: 0.0},
        r3#d92781e8#2: Vec4#3b941378{...NegVec3#52db783c."-"#3c2a4898#0(f#:3), w#3b941378#0: 0.0},
        r4#d92781e8#3: vec4#4d4983bb(x: 0.0, y: 0.0, z: 0.0, w: 1.0),
    };
}
```
*/
export const hash_123fd152: (arg_0: t_9f1c0644, arg_1: t_9f1c0644, arg_2: t_9f1c0644) => t_d92781e8 = (eye$0: t_9f1c0644, center: t_9f1c0644, up: t_9f1c0644) => {
  let f: t_9f1c0644 = hash_d508ff52(hash_8e58b954.hb99b22d8_1(center, eye$0));
  let s: t_9f1c0644 = hash_d508ff52(hash_69ae30ca(f, up));
  return ({
    type: "Mat4",
    r1: ({ ...s,
      type: "Vec4",
    ...
    r2: ({ ...hash_69ae30ca(s, f),
      type: "Vec4",
      w: 0
    } as t_3b941378),
    r3: ({ ...hash_52db783c.h3c2a4898_0(f),
      type: "Vec4",
      w: 0
    } as t_3b941378),
...
/**
```
const sceneSDF#8336009c = (iTime#:0: float#builtin, samplePoint#:1: Vec3#9f1c0644): float#builtin ={}> {
    const double#:2 = iTime#:0 *#builtin 2.0;
    const p1#:3 = opRepLim#4e4607e8(
        p: samplePoint#:1,
        c: 0.25,
...
```
*/
export const hash_8336009c: (arg_0: number, arg_1: t_9f1c0644) => number = (iTime$0: number, samplePoint: t_9f1c0644) => {
  let p1: t_9f1c0644 = hash_4e4607e8(samplePoint, 0.25, ({
    type: "Vec3",
    x: 2,
    y: 0,
    z: 0
  } as t_9f1c0644));
  return min(max(hash_39ebceb8(hash_8e58b954.hb99b22d8_1(hash_84e8317c(p1), ({
    type: "Vec3",
    x: 0.1,
    y: 0.3,
    z: 0.6
  } as t_9f1c0644))), -hash_39ebceb8(hash_8e58b954.hb99b22d8_1(hash_84e8317c(p1), ({
    type: "Vec3",
    x: 0.11,
    y: 0.2,
    z: 0.55
  } as t_9f1c0644)))), hash_39ebceb8(hash_8e58b954.hb99b22d8_1(hash_84e8317c(hash_8e58b954.hb99b22d8_1(samplePoint, ({
    type: "Vec3",
    x: 0,
    y: 1,
    z: -0.1
...
const fishingBoueys#03ba8569 = (
    ...
    const viewDir#:5 = rayDirection#09636498(fieldOfView: 45.0, size: iResolution#:3, fragCoord#:2);
    const eye#:6 = uCamera#:4;
    const viewToWorld#:7 = viewMatrix#123fd152(
        eye#:6,
    ...
    const worldDir#:8 = xyz#b3d2d308(
        v: viewToWorld#:7 *#e3e7521e#1de4e4c0#0 Vec4#3b941378{...viewDir#:5, w#3b941378#0: 0.0},
    );
    const dir#:9 = worldDir#:8;
    const dist#:10 = shortestDistanceToSurface#eaf0d810(
        sceneSDF#:0,
        iTime#:1,
        eye#:6,
    ...
    if dist#:10 >#builtin MAX_DIST#0ce717e6 -#builtin EPSILON#ec7f8d1c {
        ...
        const brightness#:15 = volumetric#76cd4800(
                    sceneSDF#:0,
                    iTime#:1,
                    seed: fragCoord#:2 /#1899d36e#5ac12902#0 iResolution#:3 
                        +#57b370c6#b99b22d8#0 iTime#:1 /#builtin 1000.0,
                    light: light1Pos#:12,
                    eye#:6,
                    dist#:10,
                    dir#:9,
            ...
            /#builtin samples#:14;
        Vec4#3b941378{
            ...white#0678f03c *#42016d26#1de4e4c0#0 brightness#:15 
                    *#42016d26#1de4e4c0#0 brightness#:15 
                *#42016d26#1de4e4c0#0 brightness#:15,
            w#3b941378#0: 1.0,
        };
    };
...
```
*/
export const hash_03ba8569: (arg_0: (arg_0: number, arg_1: t_9f1c0644) => number, arg_1: number, arg_2: t_43802a16, arg_3: t_43802a16, arg_4: t_9f1c0644) => t_3b941378 = (sceneSDF: (arg_0: number, arg_1: t_9f1c0644) => number, iTime: number, fragCoord: t_43802a16, iResolution: t_43802a16, uCamera: t_9f1c0644) => {
  let worldDir: t_9f1c0644 = hash_b3d2d308(hash_e3e7521e.h1de4e4c0_0(hash_123fd152(uCamera, ({
    type: "Vec3",
    x: 0,
    y: 0,
    z: 0
    ...
    y: 1,
    z: 0
  } as t_9f1c0644)), ({ ...hash_09636498(45, iResolution, fragCoord),
    type: "Vec4",
    w: 0
  } as t_3b941378)));
  let dist$10: number = hash_eaf0d810(sceneSDF, iTime, uCamera, worldDir, hash_f2cd39b8, hash_0ce717e6, hash_62404440);
  ...
  if (dist$10 > hash_0ce717e6 - hash_ec7f8d1c) {
    ...
    let brightness: number = hash_76cd4800(sceneSDF, iTime, hash_57b370c6.hb99b22d8_0(hash_1899d36e.h5ac12902_0(fragCoord, iResolution), iTime / 1000), ({
      type: "Vec3",
      x: 0.15 + sin(iTime / 2) / 1,
      y: 0,
      z: 0.05
    } as t_9f1c0644), uCamera, dist$10, worldDir, 0, hash_184a69ed.hAs_0(10), 10) * 3 / 10;
    return ({ ...hash_42016d26.h1de4e4c0_0(hash_42016d26.h1de4e4c0_0(hash_42016d26.h1de4e4c0_0(hash_0678f03c, brightness), brightness), brightness),
      type: "Vec4",
      w: 1
    } as t_3b941378);
  }
...
/**
```
const randFolks#0cab50cb = (env#:0: GLSLEnv#451d5252, fragCoord#:1: Vec2#43802a16): Vec4#3b941378 ={}> {
    const scale#:2 = 40.0;
    ...
    const v#:5 = random#549aecf7(st: small#:4 /#1899d36e#5ac12902#0 env#:0.resolution#451d5252#1) 
            /#builtin 10.0 
        +#builtin 0.9;
    const bouey#:6 = fishingBoueys#03ba8569(
        sceneSDF#8336009c,
        iTime: env#:0.time#451d5252#0,
        fragCoord#:1,
        iResolution: env#:0.resolution#451d5252#1,
        uCamera: env#:0.camera#451d5252#2 *#42016d26#1de4e4c0#0 -1.0,
    );
    bouey#:6;
}
```
*/
export const hash_0cab50cb: (arg_0: t_451d5252, arg_1: t_43802a16) => t_3b941378 = (env: t_451d5252, fragCoord$1: t_43802a16) => hash_03ba8569(hash_8336009c, env.time, fragCoord$1, env.resolution, hash_42016d26.h1de4e4c0_0(env.camera, -1));
export const randFolks = hash_0cab50cb;