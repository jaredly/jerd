...
```
*/
export const hash_78fab620: (arg_0: t_b79db448, arg_1: t_b79db448, arg_2: t_b79db448) => t_0d95d60e = (eye: t_b79db448, center: t_b79db448, up: t_b79db448) => {
  let f: t_b79db448 = hash_f8fba452(hash_71cd2bfd.h3d436b7e_1(center, eye));
...
```
*/
export const hash_0e55c210: (arg_0: (arg_0: t_a25a17de, arg_1: t_b79db448) => number, arg_1: t_a25a17de, arg_2: t_b79db448) => t_b79db448 = (sceneSDF: (arg_0: t_a25a17de, arg_1: t_b79db448) => number, env: t_a25a17de, p: t_b79db448) => hash_f8fba452(hash_699ede5c(sceneSDF(env, ({ ...p,
  type: "Vec3",
  x: p.x + hash_17261aaa
...
/**
```
const rec shortestDistanceToSurface#d09152ac = (
    sceneSDF#:0: (GLSLEnv#a25a17de, Vec3#b79db448) ={}> float#builtin,
    env#:1: GLSLEnv#a25a17de,
    eye#:2: Vec3#b79db448,
...
```
*/
export const hash_d09152ac: (arg_0: (arg_0: t_a25a17de, arg_1: t_b79db448) => number, arg_1: t_a25a17de, arg_2: t_b79db448, arg_3: t_b79db448, arg_4: number, arg_5: number, arg_6: number) => number = (sceneSDF: (arg_0: t_a25a17de, arg_1: t_b79db448) => number, env: t_a25a17de, eye$2: t_b79db448, marchingDirection: t_b79db448, start: number, end: number, stepsLeft: number) => {
  while (true) {
    let dist: number = sceneSDF(env, hash_71cd2bfd.h3d436b7e_0(eye$2, hash_d5810f74.h02cc25c4_0(start, marchingDirection)));
...
const getWorldDir#009f7234 = (
    ...
    xyz#3c7df3a0(
        v: viewToWorld#:6 *#af1d08f4#02cc25c4#0 Vec4#b1f05ae8{...viewDir#:4, w#b1f05ae8#0: 0.0},
    );
}
...
```
*/
export const hash_009f7234: (arg_0: t_08f7c2ac, arg_1: t_08f7c2ac, arg_2: t_b79db448, arg_3: number) => t_b79db448 = (resolution: t_08f7c2ac, coord: t_08f7c2ac, eye$2: t_b79db448, fieldOfView$3: number) => hash_3c7df3a0(hash_af1d08f4.h02cc25c4_0(hash_78fab620(({
  type: "Vec3",
  x: 0,
  y: 0,
  z: 5
  ...
  y: 1,
  z: 0
} as t_b79db448)), ({ ...hash_3ad5be38(fieldOfView$3, resolution, coord),
  type: "Vec4",
  w: 0
} as t_b1f05ae8)));
...
const rotate#50d694f8 = (
    ...
    xyz#3c7df3a0(
        v: rotate#d73bba9a(tx: x#:1, ty: y#:2, tz: z#:3) 
            *#af1d08f4#02cc25c4#0 vec4#3ffde0dc(v#:0, w: 1.0),
    );
}
(v#:0: Vec3#😦, x#:1: float, y#:2: float, z#:3: float): Vec3#😦 => xyz#⛅🕔🎑(
    MatByVector#🧏‍♀️.#Mul#👫🏭😪#0(rotate#🍕(x#:1, y#:2, z#:3), vec4#👱‍♂️🕒♟️(v#:0, 1)),
)
```
*/
export const hash_50d694f8: (arg_0: t_b79db448, arg_1: number, arg_2: number, arg_3: number) => t_b79db448 = (v: t_b79db448, x$1: number, y$2: number, z$3: number) => hash_3c7df3a0(hash_af1d08f4.h02cc25c4_0(hash_d73bba9a(x$1, y$2, z$3), hash_3ffde0dc(v, 1)));

/**
```
const marchNormals#6b24752f = (sceneSDF#:0: (GLSLEnv#a25a17de, Vec3#b79db448) ={}> float#builtin): (
    ...
    const worldDir#:4 = getWorldDir#009f7234(
    ...
    const dist#:6 = shortestDistanceToSurface#d09152ac(
        sceneSDF#:0,
        env#:1,
        eye#:3,
    ...
    if dist#:6 >#builtin maxDist#:5 -#builtin EPSILON#17261aaa {
        ...
        const worldPos#:7 = eye#:3 +#71cd2bfd#3d436b7e#0 worldDir#:4 *#637ff4d9#02cc25c4#0 dist#:6;
        const normal#:8 = estimateNormal#0e55c210(sceneSDF#:0, env#:1, p: worldPos#:7);
...
```
*/
export const hash_6b24752f: (arg_0: (arg_0: t_a25a17de, arg_1: t_b79db448) => number) => (arg_0: t_a25a17de, arg_1: t_08f7c2ac) => t_b1f05ae8 = (sceneSDF: (arg_0: t_a25a17de, arg_1: t_b79db448) => number) => (env: t_a25a17de, coord$2: t_08f7c2ac) => {
  ...
  let worldDir: t_b79db448 = hash_009f7234(env.resolution, coord$2, eye$3, 45);
  let dist$6: number = hash_d09152ac(sceneSDF, env, eye$3, worldDir, 0, 100, 255);

  if (dist$6 > 100 - hash_17261aaa) {
    return hash_ba091e3e(0);
  } else {
    return hash_3ffde0dc(hash_0e55c210(sceneSDF, env, hash_71cd2bfd.h3d436b7e_0(eye$3, hash_637ff4d9.h02cc25c4_0(worldDir, dist$6))), 1);
  }
};

/**
```
const multiSample#28a405b2 = (fn#:0: (GLSLEnv#a25a17de, Vec2#08f7c2ac) ={}> Vec4#b1f05ae8): (
    env: GLSLEnv#a25a17de,
    pos: Vec2#08f7c2ac,
) ={}> Vec4#b1f05ae8 ={}> (env#:1: GLSLEnv#a25a17de, pos#:2: Vec2#08f7c2ac): Vec4#b1f05ae8 ={}> {
    const total#:3 = fn#:0(env#:1, pos#:2) 
                    +#113c6df6#3d436b7e#0 fn#:0(
                        env#:1,
                        pos#:2 +#87e033d0#3d436b7e#0 vec2#5531df03(x: 0.5, y: 0.0),
                    ) 
                +#113c6df6#3d436b7e#0 fn#:0(
                    env#:1,
                    pos#:2 +#87e033d0#3d436b7e#0 vec2#5531df03(x: -0.5, y: 0.0),
            ...
            +#113c6df6#3d436b7e#0 fn#:0(
                env#:1,
                pos#:2 +#87e033d0#3d436b7e#0 vec2#5531df03(x: 0.0, y: 0.5),
            ) 
        +#113c6df6#3d436b7e#0 fn#:0(
            env#:1,
            pos#:2 +#87e033d0#3d436b7e#0 vec2#5531df03(x: 0.0, y: -0.5),
        );
    total#:3 /#876cd16e#3b763160#0 5.0;
}
...
```
*/
export const hash_28a405b2: (arg_0: (arg_0: t_a25a17de, arg_1: t_08f7c2ac) => t_b1f05ae8) => (arg_0: t_a25a17de, arg_1: t_08f7c2ac) => t_b1f05ae8 = (fn: (arg_0: t_a25a17de, arg_1: t_08f7c2ac) => t_b1f05ae8) => (env: t_a25a17de, pos: t_08f7c2ac) => hash_876cd16e.h3b763160_0(hash_113c6df6.h3d436b7e_0(hash_113c6df6.h3d436b7e_0(hash_113c6df6.h3d436b7e_0(hash_113c6df6.h3d436b7e_0(fn(env, pos), fn(env, hash_87e033d0.h3d436b7e_0(pos, hash_5531df03(0.5, 0)))), fn(env, hash_87e033d0.h3d436b7e_0(pos, hash_5531df03(-0.5, 0)))), fn(env, hash_87e033d0.h3d436b7e_0(pos, hash_5531df03(0, 0.5)))), fn(env, hash_87e033d0.h3d436b7e_0(pos, hash_5531df03(0, -0.5)))), 5);

/**
```
const ok#0aff6bc9 = multiSample#28a405b2(
    fn: marchNormals#6b24752f(
        sceneSDF: (env#:0: GLSLEnv#a25a17de, pos#:1: Vec3#b79db448): float#builtin ={}> {
            const pos#:2 = rotate#50d694f8(
                v: pos#:1,
                x: 0.0,
...
```
*/
export const hash_0aff6bc9: (arg_0: t_a25a17de, arg_1: t_08f7c2ac) => t_b1f05ae8 = hash_28a405b2(hash_6b24752f((env$0: t_a25a17de, pos$1: t_b79db448) => {
  let pos: t_b79db448 = hash_50d694f8(pos$1, 0, env$0.time / 2, env$0.time);
