...
/**
```
const drawSpiralCustom#64f64f6c = (
    A#:0: int#builtin,
    B#:1: int#builtin,
    C#:2: int#builtin,
    pos#:3: Vec2#78566d10,
...
```
*/
export const hash_64f64f6c: (arg_0: number, arg_1: number, arg_2: number, arg_3: t_78566d10, arg_4: number) => t_58028ffa = (A: number, B: number, C: number, pos$3: t_78566d10, length$4: number) => {
  let bottom: number = A * B + C;
  return ({
    type: "Stroke",
    geom: ({
      type: "Polygon",
      points: hash_722abb92(bottom, hash_6f186ad1.hAs_0(A) * PI / hash_6f186ad1.hAs_0(bottom), length$4, (hash_6f186ad1.hAs_0(bottom) + 1) / 2 * hash_6f186ad1.hAs_0(A) * PI, pos$3, [], bottom * 4),
      closed: false
    } as t_fa385f98),
    color: ({
      type: "CSS",
...
@display#332375b6(id: "drawable") {
    ...
    drawSpiralCustom#64f64f6c(A#:5, B#:2, C#:0, pos: vec2#6d16482a(x: 0.0), length#:4);
}
drawSpiralCustom#⏳🏇🐝😃(65 * 1 + 32 + 8 * 65 * 8, 7, 65, vec2#😌🤺🥛😃(0), 3)
*/
hash_64f64f6c(65 * 1 + 32 + 8 * 65 * 8, 7, 65, hash_6d16482a(0), 3);