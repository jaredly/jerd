...
/**
```
type Monad#488d706e<T#:0> = {
    return: <T#:1>(Item#:1) ={}> T#:0,
    bind: <T#:1, T#:2>(T#:0, (Item#:1) ={}> T#:0) ={}> T#:0,
    map: <T#:1, T#:2>(T#:0, (Item#:1) ={}> Changed#:2) ={}> T#:0,
}
```
*/
type t_488d706e<T_0> = {
  type: "488d706e";
  h488d706e_0: <T_1>(arg_0: T_1) => T_0;
  h488d706e_1: <T_1, T_2>(arg_0: T_0, arg_1: (arg_0: T_1) => T_0) => T_0;
  h488d706e_2: <T_1, T_2>(arg_0: T_0, arg_1: (arg_0: T_1) => T_2) => T_0;
};