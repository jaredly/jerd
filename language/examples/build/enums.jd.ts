...
/**
```
const check#69459ad3 = (y1#:0: OptionOrTwice#fb0d03e0<int#builtin>): bool#builtin ={}> switch y1#:0 {
...
```
*/
export const hash_69459ad3: (arg_0: t_fb0d03e0<number>) => boolean = (y1: t_fb0d03e0<number>) => {
...
/**
```
const isAs#7129afbe = (y#:0: Option#012fd7d0<int#builtin>): bool#builtin ={}> switch y#:0 {
...
```
*/
export const hash_7129afbe: (arg_0: t_012fd7d0<number>) => boolean = (y: t_012fd7d0<number>) => {
  if (y.type === "df443d10") {
...
/**
```
const isSomeYes#5b96139f = (v#:0: Option#012fd7d0<string#builtin>): bool#builtin ={}> switch v#:0 {
...
```
*/
export const hash_5b96139f: (arg_0: t_012fd7d0<string>) => boolean = (v: t_012fd7d0<string>) => {
...
/**
```
const getWithDefault#68affc1c = <T#:0>(x#:0: Option#012fd7d0<T#:0>, default#:1: T#:0): T#:0 ={}> {
...
```
*/
export const hash_68affc1c: <T_0>(arg_0: t_012fd7d0<T_0>, arg_1: T_0) => T_0 = <T_0>(x$0: t_012fd7d0<T_0>, default$1: T_0) => {
...
/**
```
const isPresent#3912c653 = <T#:0>(x#:0: Option#012fd7d0<T#:0>): bool#builtin ={}> {
...
```
*/
export const hash_3912c653: <T_0>(arg_0: t_012fd7d0<T_0>) => boolean = <T_0>(x$0: t_012fd7d0<T_0>) => {
  if (x$0.type === "df443d10") {
    return true;
  }
...
/**
```
const y1t#7be5987b = (y1#:0: OptionOrTwice#fb0d03e0<int#builtin>): int#builtin ={}> switch y1#:0 {
...
```
*/
export const hash_7be5987b: (arg_0: t_fb0d03e0<number>) => number = (y1: t_fb0d03e0<number>) => {
  if (y1.type === "4c44569a") {
...
/*
y1t#7be5987b(y1#65177da4) ==#ec95f154#51ea2a36#0 2
assertCall(IntEq#🦹‍♂️.#Eq#🦩🥜👩‍💻😃#0, y1t#💕🧞‍♂️✨😃(y1#⛹️‍♀️👨‍👦‍👦🦗😃), 2)
*/
assertCall(hash_ec95f154.h51ea2a36_0, hash_7be5987b(hash_65177da4), 2);

/*
isPresent#3912c653<int#builtin>(
...
*/
assertEqual(hash_3912c653(({
  type: "df443d10",
  hdf443d10_0: 3
} as t_012fd7d0<number>)), true);

/*
isPresent#3912c653<int#builtin>(x: Option#012fd7d0<int#builtin>:None#280d2df4) ==#builtin false
...
/*
getWithDefault#68affc1c<int#builtin>(x: Option#012fd7d0<int#builtin>:None#280d2df4, default: 20) 
...
*/
assertCall(hash_ec95f154.h51ea2a36_0, hash_68affc1c(({
  type: "280d2df4"
} as t_012fd7d0<number>), 20), 20);

/*
getWithDefault#68affc1c<int#builtin>(
        x: Option#012fd7d0<int#builtin>:Some#df443d10<int#builtin>{value#df443d10#0: 3},
        default: 20,
    ) 
...
assertCall(
    IntEq#🦹‍♂️.#Eq#🦩🥜👩‍💻😃#0,
    getWithDefault#🤗♟️🥜😃<int>(Option#🏅🎮☺️<int>:Some#🧑‍🔧{TODO SPREADs}{hdf443d10_0: 3}, 20),
    3,
)
*/
assertCall(hash_ec95f154.h51ea2a36_0, hash_68affc1c(({
...
isSomeYes#5b96139f(
    ...
    ==#builtin true
assertEqual(
    isSomeYes#☁️🏃‍♂️🤾‍♀️😃(Option#🏅🎮☺️<string>:Some#🧑‍🔧{TODO SPREADs}{hdf443d10_0: "yes"}),
    true,
)
*/
assertEqual(hash_5b96139f(({
  type: "df443d10",
  hdf443d10_0: "yes"
...
/*
isAs#7129afbe(y#36988134)
assertCall(isAs#✨🍂🕍😃, y#💂🐻‍❄️🛎️)
*/
assertCall(hash_7129afbe, hash_36988134);

/*
check#69459ad3(y1#65177da4)
assertCall(check#🍵🧞‍♂️🍖😃, y1#⛹️‍♀️👨‍👦‍👦🦗😃)
*/
assertCall(hash_69459ad3, hash_65177da4);