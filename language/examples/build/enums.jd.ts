...
/**
```
const y#1aa39702: Option#18208c90<int> = Option#18208c90<int>:None#3903f090
```
*/
...
/**
```
const check#a29e5df8: (OptionOrTwice#3015bf1c<int>) ={}> bool = (y1#:0: OptionOrTwice#3015bf1c<int>) ={}> switch y1#:0 {
...
/**
```
const isAs#54fd37b8: (Option#18208c90<int>) ={}> bool = (y#:0: Option#18208c90<int>) ={}> switch y#:0 {
    Some#58d2adaa as x#:1 => IntEq#9275f914."=="#553b4b8e#0(x#:1.value#58d2adaa#0, 2),
    None#3903f090 => true,
}
```
*/
...
/**
```
const isSomeYes#4f2d2f18: (Option#18208c90<string>) ={}> bool = (v#:0: Option#18208c90<string>) ={}> switch v#:0 {
    Some#58d2adaa{value: "no"} => false,
    None#3903f090 => false,
    Some#58d2adaa{value: v#:1} => StringEq#606c7034."=="#553b4b8e#0(v#:1, "yes"),
}
```
*/
...
/**
```
const getWithDefault#5fc3b398: <T#:0>(Option#18208c90<T#:0>, T#:0) ={}> T#:0 = <T#:0>(
    x#:0: Option#18208c90<T#:0>,
    default#:1: T#:0,
) ={}> {
...
/**
```
const isPresent#654f2202: <T#:0>(Option#18208c90<T#:0>) ={}> bool = <T#:0>(
    x#:0: Option#18208c90<T#:0>,
) ={}> {
...
/**
```
const y1#52874b44: OptionOrTwice#3015bf1c<int> = OptionOrTwice#3015bf1c<int>:y#1aa39702
```
*/
...
/**
```
const y1t#39a7754c: (OptionOrTwice#3015bf1c<int>) ={}> int = (y1#:0: OptionOrTwice#3015bf1c<int>) ={}> switch y1#:0 {
...
/**
```
const y2#02c58cda: OptionOrTwice#3015bf1c<int> = OptionOrTwice#3015bf1c<int>:Twice#294413c2<int>{
    one#294413c2#0: 3,
    two#294413c2#1: 10,
}
```
...
IntEq#9275f914."=="#553b4b8e#0(
    switch y2#02c58cda {Twice#294413c2{one: one#:0, two: two#:1} => (one#:0 + two#:1), _#:2 => 0},
    13,
)
*/
...
/*
IntEq#9275f914."=="#553b4b8e#0(y1t#39a7754c(y1#52874b44), 2)
*/
...
/*
IntEq#9275f914."=="#553b4b8e#0(
    getWithDefault#5fc3b398<int>(Option#18208c90<int>:None#3903f090, 20),
    20,
)
*/
...
/*
IntEq#9275f914."=="#553b4b8e#0(
    getWithDefault#5fc3b398<int>(Option#18208c90<int>:Some#58d2adaa<int>{value#58d2adaa#0: 3}, 20),
    3,
)
*/
assertCall(hash_9275f914.h553b4b8e_0, hash_5fc3b398(({
