...
/**
```
const y#1aa39702 = Option#18208c90<int#builtin>:None#3903f090
```
*/
...
/**
```
const check#a29e5df8 = (y1#:0: OptionOrTwice#3015bf1c<int#builtin>): bool#builtin ={}> switch y1#:0 {
...
/**
```
const isAs#54fd37b8 = (y#:0: Option#18208c90<int#builtin>): bool#builtin ={}> switch y#:0 {
...
/**
```
const isSomeYes#4f2d2f18 = (v#:0: Option#18208c90<string#builtin>): bool#builtin ={}> switch v#:0 {
...
```
*/
export const hash_5fc3b398: <T_0>(arg_0: t_18208c90<T_0>, arg_1: T_0) => T_0 = <T_0>(x: t_18208c90<T_0>, default$1: T_0) => {
  if (x.type === "58d2adaa") {
    return x.h58d2adaa_0;
  }
...
/**
```
const isPresent#654f2202 = <T#:0>(x#:0: Option#18208c90<T#:0>): bool#builtin ={}> {
    switch x#:0 {Some#58d2adaa => true, None#3903f090 => false};
}
```
*/
export const hash_654f2202: <T_0>(arg_0: t_18208c90<T_0>) => boolean = <T_0>(x: t_18208c90<T_0>) => {
  if (x.type === "58d2adaa") {
    return true;
  }
...
/**
```
const y1#52874b44 = OptionOrTwice#3015bf1c<int#builtin>:y#1aa39702
```
*/
...
/**
```
const y1t#39a7754c = (y1#:0: OptionOrTwice#3015bf1c<int#builtin>): int#builtin ={}> switch y1#:0 {
    Twice#294413c2{one: one#:1, two: two#:2} => one#:1 +#builtin two#:2,
    None#3903f090 => 2,
    _#:3 => 0,
}
```
...
/**
```
const y2#02c58cda = OptionOrTwice#3015bf1c<int#builtin>:Twice#294413c2<int#builtin>{
    one#294413c2#0: 3,
    two#294413c2#1: 10,
}
```
...
/*
switch y2#02c58cda {Twice#294413c2{one: one#:0, two: two#:1} => one#:0 +#builtin two#:1, _#:2 => 0} 
...
/*
isPresent#654f2202<int#builtin>(
        x: Option#18208c90<int#builtin>:Some#58d2adaa<int#builtin>{value#58d2adaa#0: 3},
    ) 
    ==#builtin true
*/
...
/*
isPresent#654f2202<int#builtin>(x: Option#18208c90<int#builtin>:None#3903f090) ==#builtin false
*/
assertEqual(hash_654f2202(({
  type: "3903f090"
...
/*
getWithDefault#5fc3b398<int#builtin>(x: Option#18208c90<int#builtin>:None#3903f090, default: 20) 
...
/*
getWithDefault#5fc3b398<int#builtin>(
        x: Option#18208c90<int#builtin>:Some#58d2adaa<int#builtin>{value#58d2adaa#0: 3},
        default: 20,
    ) 
...
/*
isSomeYes#4f2d2f18(
        v: Option#18208c90<string#builtin>:Some#58d2adaa<string#builtin>{value#58d2adaa#0: "yes"},
    ) 
    ==#builtin true
*/
