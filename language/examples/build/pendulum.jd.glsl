...
vec4 dataToPixel_6ca470d0(
    ...
    return ((v_0 + vec4(PI, PI, MaxVelocity_158e986a, MaxVelocity_158e986a)) / vec4(
        (PI * 2.0),
        (PI * 2.0),
...
vec4 pixelToData_446114f2(
    ...
    return ((v_0 * vec4(
        ...
        (MaxVelocity_158e986a * 2.0),
        (MaxVelocity_158e986a * 2.0)
    )) - vec4(PI, PI, MaxVelocity_158e986a, MaxVelocity_158e986a));
}
...
vec3 hsv2rgb_5c8b4a90(
    ...
    return (c_0.z * mix_1d944e78(
        ...
        clamp(
            (abs(
                ((fract((vec3(c_0.x, c_0.x, c_0.x) + vec3(1.0, (2.0 / 3.0), (1.0 / 3.0)))) * 6.0) - 3.0)
            ) - kxxx_4),
            vec3(0.0, 0.0, 0.0),
            vec3(1.0, 1.0, 1.0)
        ),
...
vec4 pendulum_bf7a10e0(
    ...
    if ((env_0.time <= 0.010)) {
        ...
        return vec4(0.0, 0.0, t_3.x, t_3.y);
    } else {
...
vec4 main_28a1e0b2(
    ...
    if ((circle_297cc3b2(p1_6, c1_7, 10.0) < 0.0)) {
        ...
        if ((circle_297cc3b2(
            ...
            if ((max(
                ...
                if ((length((p1_6 - (env_0.mouse - (env_0.resolution / 2.0)))) < 100.0)) {
                    ...
                    if ((length((p1_6 - (env_0.mouse - (env_0.resolution / 2.0)))) < 101.0)) {
                        return vec4(0.0, 0.0, 0.0, 1.0);
                    } else {
