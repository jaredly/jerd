...
/**
```
const getPerson#5d724254 = (): Person#4ddc21a8 ={Read#22024b72}> Person#4ddc21a8{
    name#4ddc21a8#0: getString#64605d94(),
    age#4ddc21a8#1: 5,
}
```
*/
export const hash_5d724254:
/*from cps lambda*/
(arg_0: Handlers, arg_1: (arg_0: Handlers, arg_1: t_4ddc21a8) => void) => void = (handlers: Handlers, done$2: (arg_0: Handlers, arg_1: t_4ddc21a8) => void) => {
  hash_64605d94(handlers, (handlers: Handlers, returnValue: string) => {
    done$2(handlers, ({
      type: "4ddc21a8",
      h4ddc21a8_0: returnValue,
      h4ddc21a8_1: 5
    } as t_4ddc21a8));
  });
};
...
/**
```
const getPersonName#271a3a70 = (): string#builtin ={Read#22024b72}> Person#4ddc21a8{
    name#4ddc21a8#0: getString#64605d94(),
    age#4ddc21a8#1: 5,
}.name#4ddc21a8#0
```
*/
export const hash_271a3a70:
/*from cps lambda*/
(arg_0: Handlers, arg_1: (arg_0: Handlers, arg_1: string) => void) => void = (handlers: Handlers, done$3: (arg_0: Handlers, arg_1: string) => void) => {
  hash_64605d94(handlers, (handlers: Handlers, returnValue$5: string) => {
      ...
      type: "4ddc21a8",
      h4ddc21a8_0: returnValue$5,
      h4ddc21a8_1: 5
    } as t_4ddc21a8).h4ddc21a8_0);
  });
};
...
/**
```
const spreadPerson#31e6e934 = (): Person#4ddc21a8 ={Read#22024b72}> Person#4ddc21a8{
    ...getPerson#5d724254(),
    age#4ddc21a8#1: 20,
}
```
*/
export const hash_31e6e934:
/*from cps lambda*/
(arg_0: Handlers, arg_1: (arg_0: Handlers, arg_1: t_4ddc21a8) => void) => void = (handlers: Handlers, done$2: (arg_0: Handlers, arg_1: t_4ddc21a8) => void) => {
  hash_5d724254(handlers, (handlers: Handlers, returnValue: t_4ddc21a8) => {
    done$2(handlers, ({ ...returnValue,
      type: "4ddc21a8",
      h4ddc21a8_1: 20
    } as t_4ddc21a8));
...
/*
provideStringPlain#2dbf3eae<Person#4ddc21a8>(v: "Me", fn: getPerson#5d724254).name#4ddc21a8#0 
    ==#606c7034#553b4b8e#0 "Me"
*/
assertCall(hash_606c7034.h553b4b8e_0, hash_2dbf3eae("Me", hash_5d724254).h4ddc21a8_0, "Me");

/*
provideStringPlain#2dbf3eae<Person#4ddc21a8>(v: "Me", fn: spreadPerson#31e6e934).name#4ddc21a8#0 
    ==#606c7034#553b4b8e#0 "Me"
*/
assertCall(hash_606c7034.h553b4b8e_0, hash_2dbf3eae("Me", hash_31e6e934).h4ddc21a8_0, "Me");
...
/*
provideStringPlain#2dbf3eae<string#builtin>(v: "ok", fn: getPersonName#271a3a70) 
    ==#606c7034#553b4b8e#0 "ok"
*/
assertCall(hash_606c7034.h553b4b8e_0, hash_2dbf3eae("ok", hash_271a3a70), "ok");