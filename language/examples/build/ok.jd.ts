...
/**
```
const getPerson#00996adc = (): Person#f13f8074 ={Read#22024b72}> Person#f13f8074{
    name#f13f8074#0: getString#64605d94(),
    age#f13f8074#1: 5,
}
(
    ...
    getString#⛷️😛🐠😃(
        ...
        (handlers#:15000: nope type: effect-handler, returnValue#:4: string): void => {
                ...
                handlers#:15000,
                Person#💌{TODO SPREADs}{hf13f8074_0: returnValue#:4, hf13f8074_1: 5},
            );
        },
    );
}
```
*/
export const hash_00996adc:
/*from cps lambda*/
(arg_0: Handlers, arg_1: (arg_0: Handlers, arg_1: t_f13f8074) => void, arg_2: Handlers, arg_3: (arg_0: Handlers, arg_1: t_f13f8074) => void) => void = (handlers: Handlers, done$2: (arg_0: Handlers, arg_1: t_f13f8074) => void) => {
  hash_64605d94(handlers, (handlers: Handlers, returnValue: string) => {
    done$2(handlers, ({
      type: "f13f8074",
      hf13f8074_0: returnValue,
      hf13f8074_1: 5
    } as t_f13f8074));
  });
};
...
/**
```
const getPersonName#0247bee0 = (): string#builtin ={Read#22024b72}> Person#f13f8074{
    name#f13f8074#0: getString#64605d94(),
    age#f13f8074#1: 5,
}.name#f13f8074#0
...
/**
```
const spreadPerson#1f1b5698 = (): Person#f13f8074 ={Read#22024b72}> Person#f13f8074{
    ...getPerson#00996adc(),
    age#f13f8074#1: 20,
}
(
    ...
    getPerson#🥃🏵️🙃(
        ...
        (handlers#:15000: nope type: effect-handler, returnValue#:4: Person#💌): void => {
            done#:2(handlers#:15000, Person#💌{TODO SPREADs}{hf13f8074_0: _#:0, hf13f8074_1: 20});
        },
    );
}
```
*/
export const hash_1f1b5698:
/*from cps lambda*/
(arg_0: Handlers, arg_1: (arg_0: Handlers, arg_1: t_f13f8074) => void, arg_2: Handlers, arg_3: (arg_0: Handlers, arg_1: t_f13f8074) => void) => void = (handlers: Handlers, done$2: (arg_0: Handlers, arg_1: t_f13f8074) => void) => {
  hash_00996adc(handlers, (handlers: Handlers, returnValue: t_f13f8074) => {
    done$2(handlers, ({ ...returnValue,
      type: "f13f8074",
      hf13f8074_1: 20
    } as t_f13f8074));
...
/*
provideStringPlain#4b7b787c<Person#f13f8074>(v: "Me", fn: getPerson#00996adc).name#f13f8074#0 
...
*/
assertCall(hash_8a86d00e.h2f333afa_0, hash_4b7b787c("Me", hash_00996adc).hf13f8074_0, "Me");

/*
provideStringPlain#4b7b787c<Person#f13f8074>(v: "Me", fn: spreadPerson#1f1b5698).name#f13f8074#0 
    ==#8a86d00e#2f333afa#0 "Me"
assertCall(
    StringEq#😍.#Eq#🧱👨‍🦰🏖️#0,
...
*/
assertCall(hash_8a86d00e.h2f333afa_0, hash_4b7b787c("Me", hash_1f1b5698).hf13f8074_0, "Me");
...
/*
provideStringPlain#4b7b787c<string#builtin>(v: "ok", fn: getPersonName#0247bee0) 
...
*/
assertCall(hash_8a86d00e.h2f333afa_0, hash_4b7b787c("ok", hash_0247bee0), "ok");