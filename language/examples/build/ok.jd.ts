...
/**
```
const getPerson#27888327 = (): Person#74d347c8 ={Read#22024b72}> Person#74d347c8{
    name#74d347c8#0: getString#64605d94(),
    age#74d347c8#1: 5,
}
(
    ...
    getString#⛷️😛🐠😃(
        ...
        (handlers#:15000: nope type: effect-handler, returnValue#:4: string): void => {
                ...
                handlers#:15000,
                Person#🧧👨‍🦲🛢️😃{TODO SPREADs}{h74d347c8_0: returnValue#:4, h74d347c8_1: 5},
            );
        },
    );
}
```
*/
export const hash_27888327:
/*from cps lambda*/
(arg_0: Handlers, arg_1: (arg_0: Handlers, arg_1: t_74d347c8) => void, arg_2: Handlers, arg_3: (arg_0: Handlers, arg_1: t_74d347c8) => void) => void = (handlers: Handlers, done$2: (arg_0: Handlers, arg_1: t_74d347c8) => void) => {
  hash_64605d94(handlers, (handlers: Handlers, returnValue: string) => {
    done$2(handlers, ({
      type: "74d347c8",
      h74d347c8_0: returnValue,
      h74d347c8_1: 5
    } as t_74d347c8));
  });
};
...
/**
```
const getPersonName#0774332a = (): string#builtin ={Read#22024b72}> Person#74d347c8{
    name#74d347c8#0: getString#64605d94(),
    age#74d347c8#1: 5,
}.name#74d347c8#0
...
/**
```
const spreadPerson#f7decd2a = (): Person#74d347c8 ={Read#22024b72}> Person#74d347c8{
    ...getPerson#27888327(),
    age#74d347c8#1: 20,
}
(
    ...
    getPerson#🚄🐻‍❄️🍑(
        ...
        (handlers#:15000: nope type: effect-handler, returnValue#:4: Person#🧧👨‍🦲🛢️😃): void => {
                ...
                handlers#:15000,
                Person#🧧👨‍🦲🛢️😃{TODO SPREADs}{h74d347c8_0: _#:0, h74d347c8_1: 20},
            );
        },
    );
}
```
*/
export const hash_f7decd2a:
/*from cps lambda*/
(arg_0: Handlers, arg_1: (arg_0: Handlers, arg_1: t_74d347c8) => void, arg_2: Handlers, arg_3: (arg_0: Handlers, arg_1: t_74d347c8) => void) => void = (handlers: Handlers, done$2: (arg_0: Handlers, arg_1: t_74d347c8) => void) => {
  hash_27888327(handlers, (handlers: Handlers, returnValue: t_74d347c8) => {
    done$2(handlers, ({ ...returnValue,
      type: "74d347c8",
      h74d347c8_1: 20
    } as t_74d347c8));
...
/*
provideStringPlain#2dbf3eae<Person#74d347c8>(v: "Me", fn: getPerson#27888327).name#74d347c8#0 
...
*/
assertCall(hash_da00b310.h51ea2a36_0, hash_2dbf3eae("Me", hash_27888327).h74d347c8_0, "Me");

/*
provideStringPlain#2dbf3eae<Person#74d347c8>(v: "Me", fn: spreadPerson#f7decd2a).name#74d347c8#0 
    ==#da00b310#51ea2a36#0 "Me"
assertCall(
    StringEq#🕌.#Eq#🦩🥜👩‍💻😃#0,
...
*/
assertCall(hash_da00b310.h51ea2a36_0, hash_2dbf3eae("Me", hash_f7decd2a).h74d347c8_0, "Me");
...
/*
provideStringPlain#2dbf3eae<string#builtin>(v: "ok", fn: getPersonName#0774332a) 
...
*/
assertCall(hash_da00b310.h51ea2a36_0, hash_2dbf3eae("ok", hash_0774332a), "ok");