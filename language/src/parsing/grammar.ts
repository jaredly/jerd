...
function peg$parse(input: string, options?: IParseOptions) {
  ...
  const peg$c53 = function(op: any, right: any): any {
      return {op, right, location: location()}
  };
  const peg$c54 = function(op: any, inner: any): any {
      if (op != null) {
  ...
  const peg$c59 = function(decorators: any, sub: any, suffixes: any): any {
  ...
  const peg$c60 = "as";
  const peg$c61 = peg$literalExpectation("as", false);
  const peg$c62 = function(hash: any, t: any): any {return {type: 'As', t, location: location(), hash}};
  const peg$c63 = "[";
  const peg$c64 = peg$literalExpectation("[", false);
  const peg$c65 = "]";
  const peg$c66 = peg$literalExpectation("]", false);
  const peg$c67 = function(slices: any): any {
      return {
          type: 'Index',
          slices,
          location: location()
  ...
  const peg$c69 = function(label: any, first: any, rest: any): any {
      return [{label, value: first}, ...rest.map((r: any) => ({label: r[3] ? r[3][0] : null, value: r[4]}))]
  };
  const peg$c70 = function(typevbls: any, effectVbls: any, args: any): any {
      return {
          type: 'Apply',
          typevbls: typevbls || [],
          effectVbls,
  ...
  const peg$c73 = function(id: any): any {return {type: 'Attribute', id, location: location()}};
  const peg$c74 = function(id: any, typeVbls: any, expr: any): any {
      return {
          type: 'Enum',
          id,
          typeVbls: typeVbls || [],
  ...
  const peg$c75 = function(id: any, typeVbls: any, effectVbls: any, rows: any): any {
      return {type: 'Record', id, rows: rows || [], location: location(), typeVbls: typeVbls || [], effectVbls}
  };
  const peg$c76 = function(first: any, rest: any): any {return [first, ...rest.map((r: any) => r[2])]};
  const peg$c77 = function(value: any): any {return {type: 'Spread', value}};
  const peg$c78 = function(id: any, value: any): any {return {type: 'Row', id, value}};
  const peg$c79 = "<";
  const peg$c80 = peg$literalExpectation("<", false);
  const peg$c81 = ">";
  const peg$c82 = peg$literalExpectation(">", false);
  const peg$c83 = function(ann: any, items: any): any {return {type: 'Array', items: items || [], location: location(), ann: ann ? ann[2] : null}};
  const peg$c84 = function(value: any): any {return {type: 'ArraySpread', value, location: location() }};
  const peg$c85 = function(items: any): any {
      if (items.length === 1) {
          return items[0]
      }
      return {type: 'Tuple', location: location(), items}
  };
  const peg$c86 = function(one: any, rest: any): any {
      return [one, ...rest.map((r: any) => r[3])]
  };
  const peg$c87 = function(items: any): any {
      return {type: 'block', items: items || [], location: location()}
  };
  const peg$c88 = "if";
  const peg$c89 = peg$literalExpectation("if", false);
  const peg$c90 = "else";
  const peg$c91 = peg$literalExpectation("else", false);
  const peg$c92 = function(cond: any, yes: any, no: any): any {
      return {type: 'If', cond, yes, no: no ? no[3] : null, location: location()}
  };
  const peg$c93 = function(v: any): any {
      return {type: 'block', items: [v], location: location()}
  };
  const peg$c94 = "switch";
  const peg$c95 = peg$literalExpectation("switch", false);
  const peg$c96 = function(expr: any, cases: any): any {
      return {type: 'Switch', expr, cases, location: location()}
  };
  const peg$c97 = "=>";
  const peg$c98 = peg$literalExpectation("=>", false);
  const peg$c99 = function(pattern: any, body: any): any {
      return {pattern, body, location: location()}
  };
  const peg$c100 = function(inner: any, as_: any): any {
      if (as_ != null) {
          return {type: 'Alias', name: as_[3], inner, location: location()}
      }
      return inner
  };
  const peg$c101 = function(items: any): any {return {type: 'Array', location: location(), items: items || []}};
  const peg$c102 = function(pattern: any): any {return {type: 'Spread', inner: pattern, location: location()}};
  const peg$c103 = function(id: any, items: any): any {
      return {type: 'Record', id, items, location: location()}
  };
  const peg$c104 = function(id: any, pattern: any): any {
      return {id, pattern: pattern ? pattern[3] : null, location: location()}};
  const peg$c105 = function(items: any): any {
      return {type: 'Tuple', location: location(), items}
  };
  const peg$c106 = "trace!(";
  const peg$c107 = peg$literalExpectation("trace!(", false);
  const peg$c108 = function(args: any): any {return {type: 'Trace', args, location: location()}};
  const peg$c109 = "raise!";
  const peg$c110 = peg$literalExpectation("raise!", false);
  const peg$c111 = function(name: any, constr: any, args: any): any {return {type: 'raise', name, constr, args: args || [], location: location()}};
  const peg$c112 = "handle!";
  const peg$c113 = peg$literalExpectation("handle!", false);
  const peg$c114 = "pure";
  const peg$c115 = peg$literalExpectation("pure", false);
  const peg$c116 = function(target: any, cases: any, pureId: any, pureBody: any): any {return {
      type: 'handle',
      target,
  ...
  const peg$c117 = function(name: any, constr: any, args: any, k: any, body: any): any {
  	return {type: 'case', name, constr, args: args || [], k, body, location: location()}
  };
  const peg$c118 = function(typevbls: any, effvbls: any, args: any, rettype: any, effects: any, body: any): any {return {
      type: 'lambda',
      typevbls: typevbls || [],
  ...
  const peg$c119 = function(id: any, type: any): any {return {id, type: type ? type[2] : null, location: location()}};
  const peg$c120 = function(id: any, subTypes: any): any {
      return {id, subTypes: subTypes ? subTypes : []}
  };
  const peg$c121 = "+";
  const peg$c122 = peg$literalExpectation("+", false);
  const peg$c123 = function(inner: any): any { return inner || [] };
  const peg$c124 = function(op: any, hash: any): any {
  ...
  const peg$c129 = function(): any {return text()};
  const peg$c130 = function(id: any, effectVbls: any, typeVbls: any): any {
      return {type: 'TypeRef', id, effectVbls, typeVbls, location: location()}
  };
  const peg$c131 = function(inner: any): any {return inner};
  const peg$c132 = function(inner: any): any {return inner || []};
  const peg$c133 = function(id: any, type: any): any {
      return {type, id: id ? id[0] : null, location: location()}
  };
  const peg$c134 = function(typevbls: any, effvbls: any, args: any, effects: any, res: any): any { return {
      type: 'lambda',
      args: args || [],
      typevbls: typevbls || [],
      location: location(),
  ...
  const peg$c136 = "true";
  const peg$c137 = peg$literalExpectation("true", false);
  const peg$c138 = "false";
  const peg$c139 = peg$literalExpectation("false", false);
  const peg$c140 = /^[0-9a-zA-Z_]/;
  const peg$c141 = peg$classExpectation([["0", "9"], ["a", "z"], ["A", "Z"], "_"], false, false);
  const peg$c142 = function(v: any): any {return {type: 'boolean', location: location(), value: v === "true"}};
  const peg$c143 = peg$otherExpectation("float");
  const peg$c144 = /^[0-9]/;
  const peg$c145 = peg$classExpectation([["0", "9"]], false, false);
  const peg$c146 = function(): any {return {type: 'float', value: parseFloat(text()), location: location()}};
  const peg$c147 = peg$otherExpectation("int");
  const peg$c148 = function(): any { return {type: 'int', value: parseInt(text(), 10), location: location()}; };
  const peg$c149 = "\"";
  const peg$c150 = peg$literalExpectation("\"", false);
  const peg$c151 = "\\";
  const peg$c152 = peg$literalExpectation("\\", false);
  const peg$c153 = peg$anyExpectation();
  const peg$c154 = /^[^"\\]/;
  const peg$c155 = peg$classExpectation(["\"", "\\"], true, false);
  const peg$c156 = function(): any {return {type: 'string', text: JSON.parse(text().replace('\n', '\\n')), location: location()}};
  const peg$c157 = function(text: any): any {
      return {type: "id", text, location: location(), }};
  const peg$c158 = function(text: any, hash: any): any {
      return {type: "id", text, location: location(), hash}};
  const peg$c159 = function(text: any, hash: any): any {
      return {type: "id", text: text.type === 'string' ? text.text : text, location: location(), hash}};
  const peg$c160 = function(): any {return text() };
  const peg$c161 = "#";
  const peg$c162 = peg$literalExpectation("#", false);
  const peg$c163 = /^[0-9a-zA-Z]/;
  const peg$c164 = peg$classExpectation([["0", "9"], ["a", "z"], ["A", "Z"]], false, false);
  const peg$c165 = "builtin";
  const peg$c166 = peg$literalExpectation("builtin", false);
  const peg$c167 = "\n";
  const peg$c168 = peg$literalExpectation("\n", false);
  const peg$c169 = /^[ \t\r]/;
  const peg$c170 = peg$classExpectation([" ", "\t", "\r"], false, false);
  const peg$c171 = peg$otherExpectation("whitespace");
  const peg$c172 = /^[ \t\n\r]/;
  const peg$c173 = peg$classExpectation([" ", "\t", "\n", "\r"], false, false);
  const peg$c174 = "/*";
                        ...
                        if (s11 !== peg$FAILED) {
                          ...
                          if (s12 !== peg$FAILED) {
                            ...
                            if (s13 !== peg$FAILED) {
                              ...
                              if (s14 !== peg$FAILED) {
                                peg$savedPos = s0;
                                s1 = peg$c118(s1, s2, s5, s9, s11, s14);
                                s0 = s1;
                              } else {
                                peg$currPos = s0;
                                s0 = peg$FAILED;
